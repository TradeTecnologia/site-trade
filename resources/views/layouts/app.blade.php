...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//cdn.datatables.net/responsive/2.1.1/css/responsive.dataTables.css"> 
    ...
    <link rel="stylesheet" href="/css/responsive.css?<?= $versao; ?>">
...
<body>
    ...
    <div class="general sistema">
        <!-- @include('includes.header-sistema') -->
