					...
					<tr>
						<td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff">
							...
							<div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;margin-top: 10px;">
								Solicitação de Análise de crédito - Formulário de simulação 
							</div>
						    ...
						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Telfone: <span style="font-weight: 400"><?= $telefone ?></span>
						    </div>

						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Cidade | Estado: <span style="font-weight: 400"><?= $cidade.' |'.$estado ?></span>
						    </div>
						    ...
						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Situação do imóvel: Imóvel é <span style="font-weight: 400"><?= $tipo_imovel ?></span>
						    </div>

						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Valor do imóvel (em R$): <span style="font-weight: 400"><?= $valor_imovel ?></span>
						    </div>

						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Valor desejado para financiamento (R$): <span style="font-weight: 400"><?= $valor_financiamento ?></span>
						    </div>

						    <div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Renda familiar (em R%): <span style="font-weight: 400"><?= $renda_familiar ?></span>
						    </div>
