...
<body style="margin:0; padding:0;" bgcolor="#CBD9FF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">

	<!-- 100% background wrapper (grey background) -->
	<table border="0" width="100%" height="100%" cellpadding="0" cellspacing="0" bgcolor="#CBD9FF">
		<tr>
			<td align="center" valign="top" bgcolor="#CBD9FF" style="background-color: #CBD9FF;">
				...
				<div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;margin-top: 10px;">
					Alguém solicitou o donwload da lista de patologias.
				</div>
				...
				<table border="0" width="600" cellpadding="0" cellspacing="0" class="container" style="width:600px;max-width:600px">
					...
					<tr>
						<td class="container-padding content" align="left" style="padding-left:24px;padding-right:24px;padding-top:12px;padding-bottom:12px;background-color:#ffffff">
							...
							<div class="title" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;font-weight:600;color:#374550;margin-bottom: 20px;">
							Celular: <span style="font-weight: 400"><?= $celular ?></span>
							</div>
